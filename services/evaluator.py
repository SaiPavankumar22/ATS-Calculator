...
from services.models import EvaluationData
from services.llm_utils import initialize_llm_provider, extract_json_from_response
import logging
import json
import re
...
class ResumeEvaluator:
    ...
    def evaluate_resume(self, resume_text: str) -> EvaluationData:
        ...
        try:
            ...
            logger.debug("Evaluation response received (%d chars)", len(response_text))
